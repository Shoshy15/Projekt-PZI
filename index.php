...
<html lang="en">
 ...
 <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-giJF6kkoqNQ00vy+HMDP7azOuL0xtbfIcaT9wjKHr8RbDVddVHyTfAAsrekwKmP1" crossorigin="anonymous">
  ...
  <body>
    ...
    <a class="navbar-brand" href="#">DRESOVI</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="infood.php">Informacije</a>
        </li>
...
<img src="pozadina.jpg" width="100%">
...
<div class="container3">
	...
	<div class = "foodpic1"><img src="slika.jpeg"></div>
	<div class = "foodpic1"><img src="2.jpeg"></div>
	<div class = "foodpic1"><img src="1.jpeg"></div><br>
	</div><br><br><br>

       <div style="text-align: center;"><h1>Za pregled ostalih proizvoda prijavite se ili registrirajte!<h1></div>
</div><br><br>
   ...
   <div id="footer">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
           ...
           <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
            ...
            <p> <i class="fas fa-envelope mr-3"></i>vladimir.oroz@gmail.com</p>
            <p> <i class="fas fa-envelope mr-3"></i>sosicivan9@gmail.com</p>
          </div>
    ...
    <hr>
    <div id="copy">
        <div class="footer-copyright text-center py-3">© 2021 FPMOZ
          <p> PZI</p>
        </div>
      </div>
